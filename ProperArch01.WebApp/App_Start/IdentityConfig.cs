...
namespace Ingenium.WebApp
{
    ...
    public class ApplicationUserManager : UserManager<GymUser>
    {
        public ApplicationUserManager(IUserStore<GymUser> store)
            : base(store)
        {
        }
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context)
        {
            ...
            manager.UserValidator = new UserValidator<GymUser>(manager)
            {
    ...
    public class ApplicationSignInManager : SignInManager<GymUser, string>
    {
